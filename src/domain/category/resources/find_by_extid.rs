...
pub async fn execute(
    ...
    if let Some(article) = article_repository.find_by_extid(&extid).await? {
...
mod tests {
    ...
    use crate::{domain::article::model::{ArticleCreateModel, ArticleUpdateModel, ArticleModel}, api::utils::{ random_string}};
   ...
   use crate::api::lib::BatchOperations;
    ...
    async fn it_should_return_article_finded() {
        ...
        let result = execute(Arc::new(article_repository), &random_string(5)).await;
